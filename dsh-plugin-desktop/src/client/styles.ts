...
/* ---- Desktop shell overlay container (hosts shell.overlay slot) ---- */
...
.dshDesktopMediaPlayer { display: block; width: 100%; max-width: 100%; max-height: none; border-radius: 8px; background: var(--dsw-alias-bg-layer-1); object-fit: contain; }
