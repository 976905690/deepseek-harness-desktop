...
.dshDesktopFrame[data-desktop-platform="win32"] .dshDesktopUpstreamSidebar { padding-top: ${WINDOWS_TITLEBAR_HEIGHT}px; -webkit-app-region: no-drag; }
.dshDesktopFrame[data-desktop-platform="linux"] .dshDesktopUpstreamSidebar { padding-top: 0; }
